...
target 'DoitSoftwareIosTestTask' do
...
target 'DoitSoftwareIosTestTaskStorage' do
  # Comment the next line if you don't want to use dynamic frameworks
  use_frameworks!

  # Pods for DoitSoftwareIosTestTaskPresentation
  pod 'ASecurity', :git => 'https://github.com/ihormyroniuk/ASecurity', :commit => '2c1f537e7a908577782f67a8d6323f57fb92b2ca'
end
